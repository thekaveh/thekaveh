...
This repo is one half of a **two-repo profile system**. Both repos present the *same* Tokyo Night "terminal session" profile — same hero, projects, skills (7 categories, 135 badges), and connect content — in two rendering environments:
